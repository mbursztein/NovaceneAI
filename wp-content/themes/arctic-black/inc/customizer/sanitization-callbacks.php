 ...
 */
function arctic_black_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function arctic_black_sanitize_css( $css ) {
 ...
 */
function arctic_black_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function arctic_black_sanitize_email( $email, $setting ) {
 ...
 */
function arctic_black_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function arctic_black_sanitize_html( $html ) {
 ...
 */
function arctic_black_sanitize_image( $image, $setting ) {
 ...
 */
function arctic_black_sanitize_nohtml( $nohtml ) {
 ...
 */
function arctic_black_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function arctic_black_sanitize_number_range( $number, $setting ) {
 ...
 */
function arctic_black_sanitize_select( $input, $setting ) {
 ...
 */
function arctic_black_sanitize_url( $url ) {
