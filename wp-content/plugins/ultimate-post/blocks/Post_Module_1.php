            ...
            'pagiColor' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-pagination li a, {{ULTP}} .ultp-next-prev-wrap ul li a, {{ULTP}} .ultp-loadmore .ultp-loadmore-action { color:{{pagiColor}}; } {{ULTP}} .ultp-next-prev-wrap ul li a svg { fill:{{pagiColor}}; } {{ULTP}} .ultp-pagination li a svg { fill:{{pagiColor}}; }'
                    ],
                ],
            ],
            'pagiBgColor' => [
    ...
    public function register() {
        register_block_type( 'ultimate-post/post-module-1',
            array(
                ...
                'keywords' => [__( 'Post grid' ), __( 'post List' ), __( 'article' ), __('Post Module')],
